...
export const Route = createFileRoute("/login")({
  component: LoginPage,
  head: () => ({ meta: [{ title: "Login — GOLDEN VAULT XM" }] }),
});
        ...
        <div className="mx-auto max-w-md px-6">
          <div className="corner-frame rounded-lg border border-gold/30 bg-card p-8 shadow-glow">
            ...
            <div className="text-center">
              <h1 className="font-display text-3xl font-bold">Welcome <span className="text-gradient-gold">Back</span></h1>
              <p className="mt-2 text-sm text-muted-foreground">Access your trading dashboard</p>
            </div>
            ...
            <p className="mt-5 text-center text-xs text-muted-foreground">
              Don't have an account? <Link to="/register" className="font-semibold text-gold">Register</Link>
            </p>
          </div>
        </div>
      </section>
